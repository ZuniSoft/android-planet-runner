...
public class Enemy1 extends Enemy {
	...
	protected float speed = 75;  //px per sec
	protected int state = -1;
	
	// Enemy frames
	protected int walkFrames[] = new int[]{0,2};
	protected int attackedFrames[] = new int[]{1,1,1};
	protected int attackHeroFrames[] = new int[]{1,1,1,1};
	protected int hitByBombFrames[] = new int[]{1,1,1,1};
	...
	public Enemy1() {
		// Animation clip
		clip = new Clip(PlanetRunner.atlas.findRegion("slime_pink"), 60, 37);
		setSize(60,37);
	...
	protected void chState(int newstate,boolean forced) {
		...
		// Waiting for prev animation to complete
